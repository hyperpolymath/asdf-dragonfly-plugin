...
:url-repo: https://github.com/hyperpolymath/asdf-dragonfly-plugin
...
image:https://img.shields.io/github/license/hyperpolymath/asdf-dragonfly-plugin?style=flat-square[License,link=LICENSE]
image:https://img.shields.io/github/v/release/hyperpolymath/asdf-dragonfly-plugin?style=flat-square[Release,link={url-repo}/releases]
image:https://img.shields.io/github/actions/workflow/status/hyperpolymath/asdf-dragonfly-plugin/ci.yml?branch=main&style=flat-square[Build Status,link={url-repo}/actions]
image:https://img.shields.io/badge/asdf-plugin-blue?style=flat-square[asdf Plugin,link={url-asdf}]

[.lead]
An {url-asdf}[asdf] plugin to install and manage {url-tool}[Dragonfly] versions.
...
Dragonfly is an upstream tool managed by this plugin. Refer to the official
...
|**Version Switching**
|Switch between Dragonfly versions per project

|**Project Isolation**
|Pin Dragonfly per repository via `.tool-versions`

|**Reproducible Builds**
|Align CI/CD and developer environments to the same Dragonfly version
...
=== Installing Dragonfly Versions

[source,bash]
----
asdf list all dragonfly
asdf install dragonfly latest
asdf install dragonfly 0.1.0
----
...
[source,bash]
----
asdf global dragonfly 0.1.0
asdf local dragonfly 0.1.0
asdf current dragonfly
dragonfly --version
----
...
* Ensure `dragonfly` is on PATH after installation.
* Verify the installed version with `dragonfly --version`.
